...
#Unless CALC_ALL=True (set for the last generation) as then print out all the parameter values
    ...
    TARGET_DISTANCE_1=20.6 # straight line km, equivalent to 30 min
    TARGET_DISTANCE_2=37 # straight line km, equivalent to 45 min
    TARGET_DISTANCE_3=54.8 # straight line km, equivalent to 60 min
